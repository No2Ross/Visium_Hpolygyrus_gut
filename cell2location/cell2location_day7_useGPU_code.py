...
#Load in visium data
day7_visium = sc.read_h5ad("/mnt/data/project0001/ross/marta_visium/cell2location/input_files/day7_merged_sections.h5ad")

#Load in reference data
intestine_immune = sc.read_h5ad("/mnt/data/project0001/ross/marta_visium/cell2location/input_files/xu_habert_merge_obj.h5ad")
...
plt.savefig("/mnt/data/project0001/ross/marta_visium/cell2location/object_files/history_train_plot_scRNA.pdf",
                bbox_inches='tight')
plt.close()
...
# Save model
mod.save('/mnt/data/project0001/ross/marta_visium/cell2location/object_files/scRNA_seq_model/GPU', overwrite=True)

# Save anndata object with results
adata_file = "/mnt/data/project0001/ross/marta_visium/cell2location/object_files/sc_GPU.h5ad"
intestine_immune.write(adata_file)
adata_file

mod.plot_QC()

plt.savefig("/mnt/data/project0001/ross/marta_visium/cell2location/object_files/accuracy_plot_scRNA.pdf",
                bbox_inches='tight')
plt.close()
...
mod = cell2location.models.RegressionModel.load(f"/mnt/data/project0001/ross/marta_visium/cell2location/object_files/scRNA_seq_model/GPU", intestine_immune)
...
# Save model
mod.save("/mnt/data/project0001/ross/marta_visium/cell2location/object_files/spatial_model/GPU", overwrite=True)
...
plt.savefig("/mnt/data/project0001/ross/marta_visium/cell2location/object_files/accuracy_plot_spatial.pdf",
                bbox_inches='tight')
plt.close()

# Save anndata object with results
adata_file = "/mnt/data/project0001/ross/marta_visium/cell2location/object_files/sp_GPU.h5ad"
...
mod = cell2location.models.Cell2location.load("/mnt/data/project0001/ross/marta_visium/cell2location/object_files/spatial_model/GPU", day7_visium)
...
adata_file = "/mnt/data/project0001/ross/marta_visium/cell2location/object_files/sp_c2c_annotated_GPU.h5ad"
day7_visium.write(adata_file)
adata_file
